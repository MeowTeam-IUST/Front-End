    ...
    <>
      {
        ...
        <div className={styles.EditProfileInputEdit}>
          ...
          <div>
            <img className={styles.button1} src={confirm} alt="" onClick={()=> setOpenEdit(false)} />
            <img className={styles.button1} src={cancel} alt="" onClick={()=> setOpenEdit(false)} />
          </div>
        </div>
        : 
        <div className={styles.EditProfileInput}>
            ...
            <img className={styles.button} src={edit} alt="" onClick={()=> setOpenEdit(true)} />
        </div>
        }
    </>
