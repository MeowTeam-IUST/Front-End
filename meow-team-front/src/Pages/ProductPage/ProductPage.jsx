        ...
        <div className={styles.w}>
          <div className={styles.wholepc}>
            <div className={styles.pccap}>
              <text className={styles.pccap1}>{productTitle}</text>
              ...
              <div className={styles.appinfo}>
                <div className={styles.appinfo1}>
                  <text className={styles.appinfo2}>درباره بازی</text>
                  <svg
                ...
                <text className={styles.appinfo3}>{productDescription}</text>
              </div>
            </div>

            <div className={styles.pcpic}></div>
          </div>
          ...
          <div className={styles.cardsofpro}>
            {products.map((product) => (
              <Productcard
                name={product.title}
                price={`قیمت ${product.price} تومان`}
                image={
